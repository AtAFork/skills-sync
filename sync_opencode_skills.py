#!/usr/bin/env python3
"""
sync_opencode_skills.py — Mirror ~/.agents/skills into ~/.config/opencode/skills as symlinks.

Similar to sync_claude_skills.py but for OpenCode's skills directory.
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Mirror ~/.agents/skills into ~/.config/opencode/skills as symlinks."
    )
    parser.add_argument(
        "--source",
    ...
    parser.add_argument(
        ...
        help="OpenCode skill root. Default: ~/.config/opencode/skills",
    )
    parser.add_argument(
        "--backup-dir",
        default=str(Path(__file__).resolve().parent / "backups" / "opencode-skills"),
    ...
    parser.add_argument(
        "--adopt-identical",
        action="store_true",
        help="Replace identical real OpenCode directories with symlinks.",
    )
    return parser
